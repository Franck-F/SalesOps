...
# Load web_body HTML
html = Path("web_body.html").read_text(encoding="utf-8")

# Let's write a function that formats the audience tab.
code = '''
# ===================== AUDIENCE WEB =====================
...
Path("scratch/tab_code.py").write_text(code, encoding="utf-8")
print("Written tab code to scratch/tab_code.py")
